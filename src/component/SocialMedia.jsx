...
export default function SocialMedia() {
  return (
    <>
      <a href="https://www.facebook.com/nasim.islam70/" target="_blank">
        <div className="btn">
          <button
            type="button"
            data-twe-ripple-init
            data-twe-ripple-color="light"
            class="mb-2  rounded bg-[#1877f2] px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
      ...
      <a href="https://www.instagram.com/nasim_islam7/" target="_blank">
        <div className="btn">
          <button
            type="button"
            data-twe-ripple-init
      ...
      <a href="https://www.linkedin.com/in/nasim-islam70/" target="_blank">
        <div className="btn">
          <button
            type="button"
            data-twe-ripple-init
